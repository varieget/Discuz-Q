...
//测试接口替换
    ...
    $route->get('register/thread.create', 'register.thread.create', \Plugin\Activity\Controller\ThreadListV1Controller::class, \App\Api\Controller\Threads\ThreadListController::class);

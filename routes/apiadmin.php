...
$route->post('/plugin/panel.upload', 'plugin.upload', ApiController\Plugin\PluginUploadController::class);
$route->post('/plugin/panel.operate', 'plugin.operate', ApiController\Plugin\PluginOperateController::class);

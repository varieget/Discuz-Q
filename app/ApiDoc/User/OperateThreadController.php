 ...
 *                @OA\Property(property="attachmentPrice",type="floor",description="附件价格"),
 *                @OA\Property(property="categoryId",type="integer",description="分类id"),
 *                @OA\Property(property="createdAt",type = "datetime", description = "创建时间"),
 *                @OA\Property(property="deletedAt",type="datetime", description = "删除时间"),
 ...
 *                @OA\Property(property="id",type="bigint", description = "帖子id"),
 ...
 *                @OA\Property(property="issueAt",type="datetime", description = "变更时间"),
 *                @OA\Property(property="lastPostedUserId",type="integer", description = "最后一次评论用户id"),
 *                @OA\Property(property="latitude",type="decimal", description = "纬度"),
 *                @OA\Property(property="location",type="string", description = "位置"),
 *                @OA\Property(property="longitude",type="decimal", description = "精度"),
 ...
 *                @OA\Property(property="price",type="decimal", description = "金额"),
 *                @OA\Property(property="rewardedCount",type="decimal", description = "奖励金额"),
 ...
 *                @OA\Property(property="updatedAt",type="datetime", description = "更新时间"),
 *                @OA\Property(property="userId",type="bigint", description = "用户id"),
 *                @OA\Property(property="viewCount",type="bigint", description = "浏览数"),
 *
 * ))
 *
 *

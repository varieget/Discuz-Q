...
//                'site_close' => (bool)$this->settings->get('site_close'),
                ...
                'site_open_sort' => (int)$this->settings->get('site_open_sort'),
                'site_open_integral' => (int)$this->settings->get('site_open_integral'),
                'site_create_thread0' => (int)$this->settings->get('site_create_thread0'),
                'site_create_thread1' => (int)$this->settings->get('site_create_thread1'),
                'site_create_thread2' => (int)$this->settings->get('site_create_thread2'),
                'site_create_thread3' => (int)$this->settings->get('site_create_thread3'),

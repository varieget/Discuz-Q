...
class WechatH5BindController extends AuthBaseController
{
    ...
    public function main()
    {
        try {
            ...
            app('errorLog')->info('requestId：' . $this->requestId . '-' . 'H5绑定获取wx用户接口异常-WechatH5BindController： ' . $e->getMessage());
        ...
        try {
            ...
            app('errorLog')->info('requestId：' . $this->requestId . '-' . 'H5绑定接口异常-WechatH5BindController： ' . $e->getMessage());
            $this->db->rollBack();
